      ...
      <Card>
        ...
        <CardContent className="flex items-center gap-6">
          <div className="relative">
            ...
            <label className="absolute -bottom-1 ltr:-right-1 rtl:-left-1 cursor-pointer rounded-full bg-primary p-1.5 text-primary-foreground shadow hover:bg-primary/90 transition-colors">
