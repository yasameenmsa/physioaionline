                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        <div className="flex items-center gap-2 min-w-0">
                          ...
                          <h3 className="font-semibold truncate min-w-0 group-hover:text-primary transition-colors">
                            {j.title}
                          </h3>
                        </div>
                        <p className="text-sm text-muted-foreground mt-1 truncate">{j.company}</p>
                      </div>
                      <span className="text-xs px-2 py-1 rounded-full bg-muted text-muted-foreground shrink-0 whitespace-nowrap">
                        {label}
                      </span>
                    </div>
